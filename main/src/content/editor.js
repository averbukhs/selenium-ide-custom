  ...
  doCommand: function (cmd) {
    ...
    switch (cmd) {
      case "cmd_close":
        ...
        break;
      case "cmd_selenium_jira":
        var jiraLinkString = editor.app.getOptions().jiraLinkString;
        var jiraProjectID = editor.app.getOptions().jiraProjectID;
        var jiraIssueType = editor.app.getOptions().jiraIssueType;
        var jiraIssueFieldID = editor.app.getOptions().jiraIssueFieldID;
        ...
        selenium.browserbot.baseUrl = jiraLinkString;
        selenuim.findElement({ id: 'create_link' }).click();
        selenuim.findElement({ id: 'project-field' }).sendKeys(jiraProjectID);
        selenuim.findElement({ id: 'issuetype-field' }).sendKeys(jiraIssueType);
        selenuim.findElement({ id: 'description' }).sendKeys("keys");
        break;
      case "cmd_save":
        editor.saveTestCase();
        break;
